	...
	SubShader
	{
		Pass
		{
			...
			v2f vert (appdata_t v)
			{
				...
				o.uv1 = TRANSFORM_TEX(v.texcoord, _StormTex);
			...
			half4 frag (v2f i) : COLOR
			{
				return tex2D(_MainTex, i.uv0) +
					tex2D(_StormTex, i.uv1) * _StormColor +
